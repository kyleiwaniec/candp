    ...
    <body>
       ...
       <script>
        ...
        $(function(){
          ...
          // If the xml file is on another domain, uncomment these lines and comment out the corresponding lines below.  
          // You will need the getfile.php. Otherwise you don't need it.'
            
          //var path = "http://www.other-domain.com/productImages.xml";

...
<script>
	...
	$(function(){	
		...
		var validator = $("#referralForm").submit(function() {
...
<form method="POST" action="" id="referralForm" class="register">
	...
	<table border="0" width="100%">
		<tr>
			<td colspan="3" width="33%" valign="top" >Email:<br>
			<input type="text" name="email" id="email" size="64" placeholder="Enter Email" class="{validate:{required:true, minlength:3}}" /><br/>
			</td>

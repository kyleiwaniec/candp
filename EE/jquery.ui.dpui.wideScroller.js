...
(function($) {
    ...
    var ws_activeItemClass = "dpui-ws-active",  //class used for active item
		...
		ws_divClass = "div";         //class used for scrollable item
    ...
    $.widget("ui.wideScroller", {
        options: {
            ...
            easing: 'easeInOutExpo',                           // can use jqueryUI easing if you include jqueryUI
            speed: 1200                                  // speed effects "tearing" so you can tweak as needed
        },

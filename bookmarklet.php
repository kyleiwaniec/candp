...
<head>
<meta charset="UTF-8">
<title>Glossy Buttons - Easy Reusable CSS - copy and paste generation</title>
...
<div>
<a title="Email RTR" href="javascript:location.href='mailto:robert@roberttherealtor.com,kyleih@optonline.net?SUBJECT='+document.title+'&BODY='+escape(location.href.history(-1))">Email RTR</a>
<br />
<br />
<br />
<a title="Email RTR" href="javascript:location.href='mailto:robert@roberttherealtor.com,kyleih@optonline.net?SUBJECT='+document.title+'&BODY='+escape(document.referrer)">Email referrer</a>
...
<script>
    ...
    $(function(){
        location.href='mailto:robert@roberttherealtor.com,kyleih@optonline.net?SUBJECT='+document.title+'&BODY='+escape(document.referrer);
    });

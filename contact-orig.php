...
function stopRKey(evt) { 
  ...
  if ((evt.keyCode == 13) && (node=="button"))  {return false;} 
} 
...
<div>
  ...
  <input type="text"  name="imgverify" id="imgverify" placeholder="please enter above characters" class="nocheck"/> <br />
</div> 
...
<canvas id="canvas" width="500" height="500">
    <em> (You can't see this really cute animation, because your browser doesn't support &lt;canvas&gt;, or you have disabled JavaScript.<br />

...
define("DEF_ALERT","kyleihduhamecoptonline.net");
...
$CSVDIR = "/home/content/i/r/e/irenaiwaniec/html/candpgeneration_com/csvdir";                       // directory for csv files; empty string to
                                    // disallow csv files
...
$FORM_INI_FILE = "/home/content/i/r/e/irenaiwaniec/html/candpgeneration_com/formmail/formmail.ini";
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_NO_DATA_PAGE] =  'This URL is a Form submission program.\n'.
        ...
        // Parameters: none
    $aMessages[MSG_REQD_ERROR] = 'The following information is missing: \n' ;

...
$TARGET_EMAIL = array(EMAIL_NAME."@cnpgen\.com$", 
                      EMAIL_NAME."@candpgeneration\.com$"
                      );

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","kyleih@optonline.net"); //,russellr@tectite.com
...
$FROM_USER = "webmaster@candpgeneration.com";                            // the default - setting not used
...
$FIXED_SENDER = "webmaster@candpgeneration.com";
...
$CSVDIR = "/home/kylehami/public_html/candpgeneration.com/csvdir";                       // directory for csv files; empty string to
                                    // disallow csv files
...
$TEMPLATEURL = "http://www.candpgeneration.com/templates";                  // default; no template URL
...
$FORM_INI_FILE = "/home/kylehami/public_html/candpgeneration.com/formmail/formmail.ini";
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_VERIFY_MISSING] = 'Image verification string missing. This'.
                                     ...
                                     ' You can use your browser\'s back button to'.
                                     ' resubmit your form, but you\'ll have to'.
                                     ' refresh the verification image'.
                                     ' by clicking the "change image" button at the bottom of the form';

            ...
            case "\\":
                ...
                // and, possibly, some digit parameter.
                    ...
                    switch (strtolower($word)) {
                        ...
                        case "par": case "page": case "column": case "line": case "lbr":  $toText .= "\n"; 
                        break;
...
<html lang="en">
    ...
    <style>
        .box{
             font:normal 16px/25px Helvetica;
    ...
    <body>
<?php    $filenames = glob("textFiles/*");
      // glob("images/*");
      // glob("../*");
      foreach($filenames as $file){
           $contents = file_get_contents($file, null, null, 0, 50);
           
           echo "<div class='box' id='$file'>";
           
           echo $contents;
           
          //echo rtf2text($file);
           echo "... <button>show more</button></div>";
      }
                        ...
                        $('button').live('click', function(){
                                var fileName = $(this).parent().attr('id');
                                 ...
                                 //alert(fileName );
                                  ...
                                  $(this).parent().load(fileName, function(){
                                    
                                        $(this).append('<button class=\"showless\">show less</button>');

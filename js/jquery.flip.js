...
$.fn.flip = function(settings){
    return this.each( function() {
		...
		var revertedSettings = {
			...
			bgColor: acceptHexColor(settings.color) || "#2a323d",
        ...
        flipObj = {
            ...
            toColor: acceptHexColor(settings.color) || "#2a323d",
            speed: settings.speed || 500,
            top: $this.offset().top,
        ...
        var defaultVertical=function() {
            ...
            return {
                ...
                "first": {
                    ...
                    borderLeftColor: '#2a323d',
                    borderRightColor: '#2a323d',

...
$(function(){   
            if(ARCS.current.mobile_weather){
            $('#adv_banner_mobile .bm_bar-center').on('click', function(){
                location.href = ARCS.current.mobile_weather;
            });
            }
            ...
            var SlideNav = (function(){
                    ...
                    var nav_outer = $('#adv_bm_nav_outer'), // outer wrapper
                        nav_inner = $('#adv_bm_nav_inner'), // inner wrapper
